...
@section('titulo', 'Encargados Editar')
@section('dependencia', ' - Policía Preventiva - ')
 
 
@section('directorioTitle', 'Encargados Editar') 
@section('directorio')
...
<div style="margin: 25px auto; width:95%;">
    ...
    {{ Form::open(array('url'=>'/administracion/encargados/'.$encargado->getId(),'method' => 'PUT','id' => 'registro','role'=>'form' )) }}
        <div class="row">
            <div class="col-sm-6 col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $encargado->getNombre() }}" name="nombre" id="nombre" class="form-control" placeholder="Nombre">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $encargado->getApellidoPaterno() }}" name="apellidoPaterno" id="apellidoPaterno" class="form-control" placeholder="apellidoPaterno">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $encargado->getApellidoMaterno() }}" name="apellidoMaterno" id="apellidoMaterno" class="form-control" placeholder="apellidoMaterno">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $encargado->getCorreo() }}" name="correo" id="correo" class="form-control" placeholder="correo">
            ...
            <div class="col-sm-6 col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $encargado->getCelular() }}" name="telefonoCelular" id="telefonoCelular" class="form-control" placeholder="telefonoCelular">  
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $encargado->getTelefono() }}" name="telefono" id="telefono" class="form-control" placeholder="telefono">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $encargado->getExtension() }}" name="extension" id="extension" class="form-control" placeholder="extension">
                ...
                <div class="form-group">
                    ...
                    <option {{ ( $tipoEncargado->getId() == $encargado->getTipoEncargado()->getId() ? "selected" : "") }} value="{{ $tipoEncargado->getId() }} "> {{$tipoEncargado->getEtiqueta()}} </option>
                    @endforeach
                    </select>

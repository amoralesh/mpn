...
<div class="col-sm-8 col-xl-10 header-right" style="background:rgba(0,28,58,1);">
   <div class="header-inner-right">
      ...
      <!-- ICONO DE FORAMATOS -->
      @include('administracion.layout.header.formatos')
      <!-- ICONO DE BUSQUEDA -->
      @include('administracion.layout.header.busqueda')
      <!-- ICONO DE CORREO 
      @include('administracion.layout.header.correo')  -->
      <!-- ICONO DE CHAT 
      @include('administracion.layout.header.chat')-->
      <!-- ICONO DE EXPANDIR -->
         ...
         <div class="btn-group">
            ...
            <div class="dropdown-menu drop-profile">
               <div class="userProfile">
                  <img src="{{ url('/') }}/public/assets/global/image/img_128x128.png" alt="Profile image"/>
                  <h5> {{ Auth::user()->getUsuario() }}  </h5> 
                  <p> {{ Auth::user()->getEmail() }} </p>
               </div>
               ...
               <a class="btn btn-primary float-xs-right right-spacing" href="{{ url('/') }}/logout" role="button" style="background:rgba(0,28,58,1);">Cerrar sesión</a>
            </div>
         </div>
      </div>
   </div>

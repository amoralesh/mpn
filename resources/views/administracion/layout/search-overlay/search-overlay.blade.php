<div class="float-default search" >
   <div class="search_bg" style="background:rgba(0,28,58,1);"></div>
   <div class="right-icon search_box">
      
      <div class="search-div">
         <input type="text" id="busquedaUniversal" class="search_input" >
         <label class="search-input-label">  
         <span class="input-label-title">Busqueda avanzada</span>
         </label>
      </div>

      <div class="divider50"></div>
      <div class="search-result" style="height:450px ;overflow-y:scroll;">
         <div class="search-item">
            <div class="search-image float-xs-left">
               <img src="{{ url('/') }}/public/assets/global/image/img_640x450.png" alt="search-image">
            </div>
            <div class="search-info float-xs-right">
               <h3 class="title">Busqueda avanzada</h3>

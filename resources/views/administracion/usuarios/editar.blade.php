...
@section('directorioTitle', 'Usuarios | Editar ')
@section('directorio')
...
<div style="margin: 25px auto; width:95%;">
   ...
   <!-- FORMULARIO PRINCIPAL
      ================================== -->
   <!-- form start -->
   {{  Form::open([ 'url' => ['/administracion/usuarios' , $id ] , 'method' => 'PUT' ]) }}
   <div class="box-body">
      <!-- NOMBRE
         ================================== -->
      ...
      <div class="form-group">
         ...
         <input type="number" value="{{ $usuario->getPlaca() }}" name="placa" id="placa" class="form-control" placeholder="Placa">
         @if ($errors->has('placa'))
         <div class="alert alert-danger">
      ...
      <div class="form-group">
         ...
         <option {{ (  $usuario->getInstitucion()->getid()  == $institucion->getid() ? "selected" : "") }} value="{{$institucion->getid()}}">{{$institucion->getNombre()}}</option>
         @endforeach
         </select>

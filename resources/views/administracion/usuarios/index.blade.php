...
@section('titulo', 'Usuarios | Lista')
@section('dependencia', ' - Policía Preventiva - ')


@section('directorioTitle', 'Usuarios | Lista')
@section('directorio')
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var table = $('#usuariosDT').DataTable({
            ...
            "processing": true,
            "ajax": {
                "url": "{{ url('/') }}/administracion/rest/usuarios/usuarios",
                "type": "GET",
                "dataSrc": "",
        ...
        $('#usuariosDT tbody').on('click', '#modificarUsuario', function(e) {
            ...
            document.location.href = "{{ url('/') }}/administracion/usuarios/" + id + "/edit";
        ...
        $('#usuariosDT tbody').on('click', '#bajaUsuario', function(e) {
            ...
            swal({
                ...
                cancelButtonText: 'No, cancelar'
                    ...
                    $.ajax({
                        url: "{{ url('/') }}/administracion/rest/usuarios/usuarios/deshabilitar",
                        type: "POST",
                        data: {
                            id: idUsuario
                        },
        ...
        $('#usuariosDT tbody').on('click', '#altaUsuario', function(e) {
            ...
            swal({
                ...
                cancelButtonText: 'No, cancelar'
                    ...
                    $.ajax({
                        url: "{{ url('/') }}/administracion/rest/usuarios/usuarios/habilitar",
                        type: "POST",
                        data: {
                            id: idUsuario
                        },
        ...
        $("#nuevoUsuario").click(function() {
            document.location.href = "{{ url('/') }}/administracion/usuarios/create"; //+ "/edit";
        });

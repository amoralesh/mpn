...
@section('titulo', 'Usuarios Publico| Editar')
@section('dependencia', ' - Policía Preventiva - ')


@section('directorioTitle', 'Usuarios Publico| Editar ')
@section('directorio')
	<li class="breadcrumb-item"><a href="{{ url('/') }}/usuarios">Usuarios</a></li>
    <li class="breadcrumb-item active">Publico</li>
...
<div style="margin: 25px auto; width:95%;">
   ...
   <!-- FORMULARIO PRINCIPAL
      ================================== -->
   <!-- form start -->
   {{  Form::open([ 'url' => ['/administracion/usuariospublico' , $id ] , 'method' => 'PUT' ]) }}
   <div class="box-body">
      <!-- NOMBRE
         ================================== -->
      ...
      <div class="form-group">
         ...
         <option {{ (  $usuario->getInstitucionPublico()->getid()  == $institucion->getid() ? "selected" : "") }} value="{{$institucion->getid()}}">{{$institucion->getNombre()}}</option>
         @endforeach
         </select>
...
<script>
    ...
    $(function() {
        ...
        var tableRoles = $('#permisosDT').DataTable({
            ...
            "processing": true,
            "ajax": {
                "url": "{{ url('/') }}/administracion/rest/usuariospublico/permisos",
                "type": "GET", 
                "dataSrc": "",

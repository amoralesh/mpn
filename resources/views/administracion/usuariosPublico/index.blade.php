...
@section('titulo', 'Usuarios Publicos| Lista')
@section('dependencia', ' - Policía Preventiva - ')


@section('directorioTitle', 'Usuarios Publicos| Lista')
@section('directorio')
    <li class="breadcrumb-item">Usuarios</li>
    <li class="breadcrumb-item">Publicos</li>
@endsection
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var table = $('#usuariosDT').DataTable({
            ...
            "processing": true,
            "ajax": {
                "url": "{{ url('/') }}/administracion/rest/usuariospublico/usuarios",
                "type": "GET",
                "dataSrc": "",
        ...
        $('#usuariosDT tbody').on('click', '#modificarUsuario', function(e) {
            ...
            document.location.href = "{{ url('/') }}/administracion/usuariospublico/" + id + "/edit";
        ...
        $('#usuariosDT tbody').on('click', '#bajaUsuario', function(e) {
            ...
            swal({
                ...
                cancelButtonText: 'No, cancelar'
                    ...
                    $.ajax({
                        url: "{{ url('/') }}/administracion/rest/usuariospublico/deshabilitar",
                        type: "POST",
                        data: {
                            id: idUsuario
                        },
        ...
        $('#usuariosDT tbody').on('click', '#altaUsuario', function(e) {
            ...
            swal({
                ...
                cancelButtonText: 'No, cancelar'
                    ...
                    $.ajax({
                        url: "{{ url('/') }}/administracion/rest/usuariospublico/habilitar",
                        type: "POST",
                        data: {
                            id: idUsuario
                        },
        ...
        $("#nuevoUsuario").click(function() {
            document.location.href = "{{ url('/') }}/administracion/usuariospublico/create"; //+ "/edit";
        });

...
@section('titulo', 'Negocios que cuentan con dispositivos en modo prueba')
@section('dependencia', ' - Policía Preventiva - ')


@section('directorioTitle', 'Negocios que cuentan con dispositivos en modo prueba')
@section('directorio')
    <li class="breadcrumb-item ">Negocios que cuentan con dispositivos en modo prueba</li> 
@endsection  
...
<script>
    $(function() {
        ...
        $('#crear').on('click', function(e) {
            document.location.href = "{{ url('/') }}/administracion/escuelas/create";
            e.stopPropagation();
        });
    ...
    function listAllEstablecimientos(){
        ...
        var table = $('#negociosDT').DataTable({
            ...
            "processing": true,
            "ajax": {  
                "url": "{{ url('/') }}/administracion/rest/establecimientos/pruebas",
                "type": "POST",  
                "data": {
                    _token: token
                },
        ...
        $('#negociosDT tbody').on('click', '#editar', function(e) {
            ...
            var data = table.row(current_row).data();
            document.location.href = "{{ url('/') }}/administracion/escuelas/" + data.id + "/edit";
            e.stopPropagation();
        });
                ...
                preConfirm: function (motivo) {
                    return new Promise(function (resolve, reject) {
                        setTimeout(function() {
                            ...
                            $.ajax({
                                url: "{{ url('/') }}/administracion/rest/escuelas/habilitar",
                                type: "POST",
                                data: { 
                ...
                preConfirm: function (motivo) {
                    return new Promise(function (resolve, reject) {
                        setTimeout(function() {
                            ...
                            $.ajax({
                                url: "{{ url('/') }}/administracion/rest/escuelas/deshabilitar",
                                type: "POST",
                                data: { 
                                    id: idEstablecimiento,
                                    motivoAltaBaja: motivo
    ...
    function findEstablecimientoById( data ) {      
                    ...
                    var dispositivosInfo =
                        '<table class="table table-striped table-bordered table-hover" id="dispositivosDT">'+
                            ...
                            jQuery.each( dispositivos , function( indice , dispositivo ) { 
                                ...
                                var status = dispositivo.status == 'Activo' ? '<div onclick="desactivarDispositivo(\''+dispositivo.etiqueta+'\','+dispositivo.id+')" class="" style="color: rgba(255,80,80,1);"><button type="button" class="btn btn-primary" style="width:150px; margin-top:2px"><i class="fa fa-times-circle"></i> Desactivar</button></div>' 
                                : '<div onclick="activarDispositivo(\''+dispositivo.etiqueta+'\','+dispositivo.id+')" class="" style="color: rgba(255,80,80,1);"><button type="button" class="btn btn-primary" style="width:150px; margin-top:2px"><i class="fa fa-times-circle"></i> Activar</button></div>' ;
                                
                                var pruebas = dispositivo.tipoStatus == 'Activo' ? '<div onclick="pruebas(\''+dispositivo.etiqueta+'\','+dispositivo.id+')" class="" style="color: rgba(255,80,80,1);"><button type="button" class="btn btn-primary" style="width:150px; margin-top:2px"><i class="fa fa-times-circle"></i> A Pruebas</button></div>'
                                : '<div onclick="real(\''+dispositivo.etiqueta+'\','+dispositivo.id+')" class="" style="color: rgba(255,80,80,1);"><button type="button" class="btn btn-primary" style="width:150px; margin-top:2px ;background-color:#34B7BF;"><i class="fa fa-times-circle"></i> A real</button></div>';
                                ...
                                '<tr>' +
                                    ...
                                    '<td>' + 
                                        ...
                                        @if( in_array( 'Administracion:Establecimientos:Actualizar:Token' , Session::get('permisos') ) )
                                            '<div onclick="renovarToken(\''+dispositivo.etiqueta+'\','+dispositivo.id+')" class="" style="color: rgba(255,80,80,1);"><button type="button" class="btn btn-primary" style="width:150px; margin-top:2px"><i class="fa fa-times-circle"></i> Token</button></div>' + 
                                        @endif
                                        status + 
                                        pruebas + 
                                    '</td>' + 
        ...
        function renovarToken(nombre, idDispositivo) 
        {
            console.log( idDispositivo );
            swal({
                title: 'Renovar token ?',
                text: 'El dispositivo ' + nombre + ' ya NO podrá enviar alertas ni pruebas, quedara completamente deshabilitado el token anterior y sera remplazado por uno nuevo',
                type: 'warning',
                showCancelButton: true,
                ...
                preConfirm: function(motivo) {
                    return new Promise(function(resolve, reject) {
                        setTimeout(function() {
                            $.ajax({     
                                url: "{{ url('/') }}/administracion/rest/dispositivos/actualizar/token",
                                type: "POST",
                                data: {
                                    id: idDispositivo
                                },
                                dataType: "html",
                                success: function() {
                                    swal('Renovado!', 'El token ha sido renovado.', 'success')
                                    table.ajax.reload();
                                },
                                error: function(xhr, ajaxOptions, thrownError) {
                                    swal("Error al renovar!", "Intenta más tarde", "error");
                                }
                            });
                        }, 3000)
                    })
        ...
        function activarDispositivo(nombre, idDispositivo) 
        {
            console.log( idDispositivo );
            swal({
                title: 'Habilitar Dispositivo ?',
                text: 'El dispositivo ' + nombre + ' ya podrá enviar alertas y pruebas.',
                type: 'warning',
                showCancelButton: true,
                confirmButtonText: 'Si, habilitar!',
                cancelButtonText: 'No, cancelar',
                ...
                preConfirm: function(motivo) {
                    return new Promise(function(resolve, reject) {
                        setTimeout(function() {
                            $.ajax({     
                                url: "{{ url('/') }}/administracion/rest/dispositivos/habilitar",
                                type: "POST",
                                data: {
                                    id: idDispositivo
                                },
                                dataType: "html",
                                success: function() {
                                    swal('Habilitado!', 'El dispositivo ha sido habilitado.', 'success')
                                    table.ajax.reload();
                                },
                                error: function(xhr, ajaxOptions, thrownError) {
                                    swal("Error al habilitar!", "Intenta más tarde", "error");
        ...
        function desactivarDispositivo(nombre, idDispositivo) 
        {
            console.log( idDispositivo );
            swal({
                title: 'Deshabilitar Dispositivo ?',
                text: 'El dispositivo ' + nombre + ' ya NO podrá enviar alertas y pruebas.',
                type: 'warning',
                showCancelButton: true,
                confirmButtonText: 'Si, Deshabilitar!',
                cancelButtonText: 'No, cancelar',
                ...
                preConfirm: function(motivo) {
                    return new Promise(function(resolve, reject) {
                        setTimeout(function() {
                            $.ajax({     
                                url: "{{ url('/') }}/administracion/rest/dispositivos/deshabilitar",
                                type: "POST",
                                data: {
                                    id: idDispositivo
                                },
        ...
        function pruebas(nombre, idDispositivo) 
        {
            console.log( idDispositivo );
            swal({
                title: 'Mandar a pruebas al Dispositivo ?',
                text: 'El dispositivo ' + nombre + ' SI podrá enviar alertas y pruebas, pero no seran mostradas en puesto de mando, solo seran mostradas dentro de la plataforma, IDEAL PARA LAS PRUEBAS REALES',
                type: 'warning',
                showCancelButton: true,
                confirmButtonText: 'Si, Mandar a pruebas!',
                cancelButtonText: 'No, cancelar',
                showLoaderOnConfirm: true,
                preConfirm: function(motivo) {
                    return new Promise(function(resolve, reject) {
                        setTimeout(function() {
                            $.ajax({     
                                url: "{{ url('/') }}/administracion/rest/dispositivos/pruebas",
                                type: "POST",
                                data: {
                                    id: idDispositivo
                                },
                                dataType: "html",
                                success: function() {
                                    swal('OK!', 'El dispositivo ha sido mandado a pruebas.', 'success')
                                    table.ajax.reload();
                                },
                                error: function(xhr, ajaxOptions, thrownError) {
                                    swal("Error al mandar a pruebas!", "Intenta más tarde", "error");
                                }
                            });
                        }, 3000)
                    })
        ...
        function real(nombre, idDispositivo) 
        {
            console.log( idDispositivo );
            swal({
                title: 'Mandar a real al Dispositivo ?',
                text: 'El dispositivo ' + nombre + ' podrá enviar alertas y pruebas , seran mostradas en puesto de mando',
                type: 'warning',
                showCancelButton: true,
                confirmButtonText: 'Si, Mandar a real!',
                cancelButtonText: 'No, cancelar',
                showLoaderOnConfirm: true,
                preConfirm: function(motivo) {
                    return new Promise(function(resolve, reject) {
                        setTimeout(function() {
                            $.ajax({     
                                url: "{{ url('/') }}/administracion/rest/dispositivos/real",
                                type: "POST",
                                data: {
                                    id: idDispositivo
                                },
                                dataType: "html",
                                success: function() {
                                    swal('OK!', 'El dispositivo ha sido mandado a real.', 'success')
                                    table.ajax.reload();
                                },
                                error: function(xhr, ajaxOptions, thrownError) {
                                    swal("Error al mandar a real!", "Intenta más tarde", "error");
                                }
                            });
                        }, 3000)
                    })
                    ...
                    var pruebasInfo =
                        '<table class="table table-striped table-bordered table-hover" id="pruebasDt">'+
                            ...
                            jQuery.each( pruebas , function( indice , prueba ) { 
                                ...
                                var cadenasInfo = "";
                                jQuery.each( prueba.cadenas , function( indice , cadena ) { 
                                    cadenasInfo += cadena.etiqueta + "</br>";
                                });
                                
                                var zonasInfo = "";
                                jQuery.each( prueba.zonas , function( indice , zona) { 
                                    zonasInfo += zona.etiqueta + "</br>";
                                });
                    ...
                    var alertasInfo =
                        '<table class="table table-striped table-bordered table-hover" id="alertasDt">'+
                            ...
                            jQuery.each( alertas , function( indice , alerta ) { 
                                ...
                                var cadenasInfo = "";
                                jQuery.each( alerta.cadenas , function( indice , cadena ) { 
                                    cadenasInfo += cadena.etiqueta + "</br>";
                                });
                                
                                var zonasInfo = "";
                                jQuery.each( alerta.zonas , function( indice , zona) { 
                                    zonasInfo += zona.etiqueta + "</br>";
                                });

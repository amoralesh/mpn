...
@section('titulo', 'Establecimiento Editar')
@section('dependencia', ' - Policía Preventiva - ')
@section('directorioTitle', 'Establecimiento Editar') 



@section('directorioTitle', 'Establecimiento Editar')
@section('directorio')
    <li class="breadcrumb-item ">Establecimiento</li>
...
<div style="margin: 25px auto; width:95%;">
    ...
    {{ Form::open(array('url'=>'/administracion/establecimientos/' . $negocio->getId(),'method' => 'PUT','enctype' => 'multipart/form-data','id' => 'registro','role'=>'form' )) }}

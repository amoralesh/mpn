        ...
        var table = $('#negociosDT').DataTable({
            ...
            "columnDefs": [
                ...
                {     
                    ...
                    @if( in_array( 'Administracion:Establecimientos:Deshabilitar' , Session::get('permisos') ) )
                        if (row.status == true) { 
                ...
                success: function ( dispositivos ) {
                    ...
                    var dispositivosInfo =
                        '<table class="table table-striped table-bordered table-hover" id="dispositivosDT">'+
                            ...
                            @if( in_array( 'Administracion:Establecimientos:Dispositivo:DesactivarActivar' , Session::get('permisos') ) ) 
                            ...
                            @endif
                                ...
                                '<tr>' +
                                    ...
                                    '<td> https://mipolicia.ssp.cdmx.gob.mx/mpn/rest/alertas/activar/' + dispositivo.token + '</td>' +

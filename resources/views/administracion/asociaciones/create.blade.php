...
@section('titulo', 'Asociación Nueva')
@section('dependencia', ' - Policía Preventiva - ')


@section('directorioTitle', 'Asociación Nueva')
@section('directorio')
...
<div style="margin: 25px auto; width:95%;">
    ...
    {{ Form::open(array('url'=>'/administracion/asociaciones','method' => 'POST','id' => 'registro','role'=>'form' )) }}
        <div class="row">

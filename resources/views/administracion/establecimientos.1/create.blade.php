...
@section('titulo', 'Establecimiento Nuevo')
@section('dependencia', ' - Policía Preventiva - ')
@section('directorioTitle', 'Establecimiento Nuevo') 



@section('directorioTitle', 'Establecimiento Nueva')
@section('directorio')
...
<div style="margin: 25px auto; width:95%;">
    ...
    {{ Form::open(array('url'=>'/administracion/establecimientos','method' => 'POST','enctype' => 'multipart/form-data','id' => 'registro','role'=>'form' )) }}
        ...
        <div class="form-group" id="numLocalMercado" style="display: none; z-index:1;">
            ...
            <input type="text" value="{!! old('numeroDeEstablecimientosMercado') !!}" name="numeroDeEstablecimientosMercado" id="numeroDeEstablecimientosMercado" maxlength="5" class="form-control" placeholder="Número Locales">
        ...
        <!-- MERCADO TABLA
        ================================== -->
        <section style="margin-top:20px; display: none; z-index:1;" id="puertas" name="puertas">
            ...
            <button type="button" id="agregarPuerta" name="agregarPuerta">Añadir puerta</button>
        </section>

...
@section('directorioTitle', 'Tipo Dispositivo Editar') 
@section('directorio')
    <li class="breadcrumb-item ">Tipo Dispositivo Editar</li>
...
<div class="box">
    ...
    <div class="box-body">
        ...
        {{ Form::open(array('url'=>'/administracion/catalogo/tipoDispositivo/'.$tipoDispositivo->getId(),'method' => 'put','id' => 'registro','role'=>'form' )) }}
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$tipoDispositivo->getEtiqueta()}}" name="nombre" id="nombre" class="form-control" placeholder="Nombre">
    ...
    <div class="box-footer">
        En este apartado podemos modificar tipoDispositivo
    </div>
    <!-- /.box-footer-->
</div>
<!-- /.box -->

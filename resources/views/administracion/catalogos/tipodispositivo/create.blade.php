...
@section('directorio') 
    <li class="breadcrumb-item"><a href="{{ url('/') }}/administracion/catalogo/tipoDispositivo">Tipo Dispositivo</a></li> 
...
<div style="margin: 25px auto; width:95%;">
    ...
    {{ Form::open(array('url'=>'/administracion/catalogo/tipoDispositivo','method' => 'post','id' => 'registro','role'=>'form' )) }}

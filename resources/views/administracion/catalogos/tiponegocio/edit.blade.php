...
@section('titulo', 'Tipo Negocio Editar')
...
<div class="box">
    ...
    <div class="box-body">
        ...
        {{ Form::open(array('url'=>'/administracion/catalogo/tipoNegocios/'.$tipoNegocio->getId(),'method' => 'PUT','id' => 'registro','role'=>'form' )) }}
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$tipoNegocio->getEtiqueta()}}" name="nombre" id="nombre" class="form-control" placeholder="Nombre">

...
@section('titulo', 'Tipo Negocio Nuevo')
...
@section('directorio')
    <li class="breadcrumb-item"><a href="{{ url('/') }}/administracion/catalogo/tipogirosgenerales">Tipo Negocio</a></li> 
...
<div style="margin: 25px auto; width:95%;">
    ...
    {{ Form::open(array('url'=>'/administracion/catalogo/tipoNegocios','method' => 'post','id' => 'registro','role'=>'form' )) }}

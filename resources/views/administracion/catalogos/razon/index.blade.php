...
@section('directorioTitle', 'Razones') 
@section('directorio')
    <li class="breadcrumb-item ">Razon</li>
@endsection   
...
<div style="margin: 25px auto; width:95%;">
    ...
    <button type="button" id="crear" class="btn btn-primary">Crear nueva razón</button>
     
    <section style="margin-top:20px;"> 
        <table class="table table-striped table-bordered table-hover" id="razonesDT">
            <thead>
                <tr>
					<th>#</th>
					<th>Razon</th>
...
<script>
    $(function() {
		...
		$('#crear').on('click', function(e){
			document.location.href = "{{ url('/') }}/administracion/catalogo/razones/create";
			e.stopPropagation();
		});
	 ...
	 function listAllRazones(){
		 
		var table = $('#razonesDT').DataTable({
						...
						"processing" : true,
						"ajax"   :  {
		    				"url"  : "{{ url('/') }}/administracion/rest/catalogo/razones",
		    				"type" : "GET",
								"dataSrc": "",
				...
				$('#razonesDT tbody').on('click', '#editar', function(e){
					...
					document.location.href = "{{ url('/') }}/administracion/catalogo/razones/" + id + "/edit";
					e.stopPropagation();
				});

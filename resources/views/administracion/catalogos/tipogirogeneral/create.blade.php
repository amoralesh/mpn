...
@section('directorio')
    <li class="breadcrumb-item"><a href="{{ url('/') }}/administracion/catalogo/tipogirosgenerales">Tipo Giro General</a></li> 
...
<div style="margin: 25px auto; width:95%;">
    ...
    {{ Form::open(array('url'=>'/administracion/catalogo/tipogirosgenerales','method' => 'post','id' => 'registro','role'=>'form' )) }}

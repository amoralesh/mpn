...
@section('directorioTitle', 'Nueva Participación')  
@section('directorio') 
    <li class="breadcrumb-item"><a href="{{ url('/') }}/administracion/catalogo/participaciones">Participación</a></li>
...
<div style="margin: 25px auto; width:95%;">
    ...
    {{ Form::open(array('url'=>'/administracion/catalogo/participaciones','method' => 'post','id' => 'registro','role'=>'form' )) }}

...
@section('directorioTitle', 'Editar Participación') 
@section('directorio')
...
<div style="margin: 25px auto; width:95%;">
   ...
   <div class="box">
      ...
      <div class="box-body">
         ...
         @endif
         {{ Form::open(array('url'=>'/administracion/catalogo/participaciones/'.$participacion->getId(),'method' => 'PUT','id' => 'registro','role'=>'form' )) }}
         <div class="row">
            <div class="col-sm-12 col-md-12">
               ...
               <div class="form-group">
                  ...
                  <input type="text" value="{{$participacion->getEtiqueta()}}" name="nombre" id="nombre" class="form-control" placeholder="Nombre">
         ...
         <div class="box-footer">
            En este apartado podemos modificar participación
         </div>
         <!-- /.box-footer-->
      </div>
      <!-- /.box -->

...
@section('titulo', 'Tipo Giro Editar')
...
<div class="box">
    ...
    <div class="box-body">
        ...
        {{ Form::open(array('url'=>'/administracion/catalogo/tipoGiros/'.$tipoGiro->getId(),'method' => 'put','id' => 'registro','role'=>'form' )) }}
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$tipoGiro->getEtiqueta()}}" name="nombre" id="nombre" class="form-control" placeholder="Nombre">

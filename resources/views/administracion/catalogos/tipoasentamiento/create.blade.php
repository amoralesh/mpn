...
@section('directorio')
    <li class="breadcrumb-item"><a href="{{ url('/') }}/administracion/catalogo/delegaciones">Tipo Asentamiento</a></li> 
...
<div style="margin: 25px auto; width:95%;">
    ...
    {{ Form::open(array('url'=>'/administracion/catalogo/tipoAsentamientos','method' => 'post','id' => 'registro','role'=>'form' )) }}

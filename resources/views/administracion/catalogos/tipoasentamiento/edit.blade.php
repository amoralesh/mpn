...
@section('titulo', 'Tipo Asentamiento Editar')
@section('dependencia', ' - Policía Preventiva - ')


@section('directorioTitle', 'Tipo Asentamiento Editar') 
@section('directorio')
...
<div class="box">
    ...
    <div class="box-body">
        ...
        {{ Form::open(array('url'=>'/administracion/catalogo/tipoAsentamientos/'.$tipoAsentamiento->getId(),'method' => 'PUT','id' => 'registro','role'=>'form' )) }}
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$tipoAsentamiento->getEtiqueta()}}" name="nombre" id="nombre" class="form-control" placeholder="Nombre">
    ...
    <div class="box-footer">
        En este apartado podemos modificar tipoAsentamiento
    </div>
    <!-- /.box-footer-->
</div>
<!-- /.box -->

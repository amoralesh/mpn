...
@section('titulo', 'Tipo Encargado Editar')
...
<div class="box">
    <div class="box-body">
        ...
        {{ Form::open(array('url'=>'/administracion/catalogo/tipoencargado/'.$tipoEncargado->getId(),'method' => 'put','id' => 'registro','role'=>'form' )) }}
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$tipoEncargado->getEtiqueta()}}" name="nombre" id="nombre" class="form-control" placeholder="Nombre">
    ...
    <div class="box-footer">
        En este apartado podemos modificar tipo Encargado
    </div>
    <!-- /.box-footer-->
</div>
<!-- /.box -->

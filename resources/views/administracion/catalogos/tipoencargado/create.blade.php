...
@section('titulo', 'Tipo Encargado Nuevo')
@section('dependencia', ' - Policía Preventiva - ')


@section('directorioTitle', 'Tipo Encargado') 
@section('directorio')
    <li class="breadcrumb-item"><a href="{{ url('/') }}/administracion/catalogo/tipoencargado">Tipo Encargado</a></li> 
...
<div style="margin: 25px auto; width:95%;">
    ...
    {{ Form::open(array('url'=>'/administracion/catalogo/tipoencargado','method' => 'post','id' => 'registro','role'=>'form' )) }}

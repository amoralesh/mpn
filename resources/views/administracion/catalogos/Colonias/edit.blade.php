...
@section('titulo', 'Colonia Editar')
@section('dependencia', ' - Policía Preventiva - ')

@section('directorioTitle', 'Colonia Editar')
@section('directorio')
...
<div style="margin: 25px auto; width:95%;">
   ...
   <div class="box">
      <div class="box-body">
         ...
         @endif
         {{ Form::open(array('url'=>'/administracion/catalogo/colonias/'.$colonia->getId(),'method' => 'put','id' => 'registro','role'=>'form' )) }}
         <div class="row">
            <div class="col-sm-12 col-md-12">
               ...
               <div class="form-group">
                  ...
                  <option {{(  $delegacion->getid() == $colonia->getDelegacion()->getId() ? "selected" : "") }} value="{{ $delegacion->getid() }} "> {{$delegacion->getEtiqueta()}} </option>
                  @endforeach
                  </select>
               ...
               <div class="form-group">
                  ...
                  <input type="text" value="{{$colonia->getEtiqueta()}}" name="nombre" id="nombre" class="form-control" placeholder="Nombre">

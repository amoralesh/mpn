...
@section('directorioTitle', 'Colonias')
@section('directorio')
    <li class="breadcrumb-item ">Colonias</li>
@endsection 
...
<div style="margin: 25px auto; width:95%;">
    ...
    <button type="button" id="crear" class="btn btn-primary">Crear nueva colonia</button>
    
    <section style="margin-top:20px;"> 
        <table class="table table-striped table-bordered table-hover" id="coloniasDT">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Delegación</th>
...
<script>
    $(function() {
        ...
        $('#crear').on('click', function(e) {
            document.location.href = "{{ url('/') }}/administracion/catalogo/colonias/create";
            e.stopPropagation();
        });
    ...
    function listAllColonias(){
        
        var table = $('#coloniasDT').DataTable({
            ...
            "processing": true, 
            "ajax": {
                "url": "{{ url('/') }}/administracion/rest/catalogo/colonias",
                "type": "POST",
        ...
        $('#coloniasDT tbody').on('click', '#editar', function(e) {
            ...
            document.location.href = "{{ url('/') }}/administracion/catalogo/colonias/" + id + "/edit";
            e.stopPropagation();
        });

...
@section('directorioTitle', 'Editar Tipo Status') 
@section('directorio')
...
<div style="margin: 25px auto; width:95%;">
   ...
   <div class="box">
      ...
      <div class="box-body">
         ...
         @endif
         {{ Form::open(array('url'=>'/administracion/catalogo/tipostatus/'.$status->getId(),'method' => 'PUT','id' => 'registro','role'=>'form' )) }}
         <div class="row">
            <div class="col-sm-12 col-md-12">
               ...
               <div class="form-group">
                  ...
                  <input type="text" value="{{$status->getEtiqueta()}}" name="nombre" id="nombre" class="form-control" placeholder="Nombre">
         ...
         <div class="box-footer">
            En este apartado podemos modificar status
         </div>
         <!-- /.box-footer-->
      </div>
      <!-- /.box -->

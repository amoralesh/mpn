...
@section('directorioTitle', 'Nuevo Motivo de Alarma') 
@section('directorio')
    <li class="breadcrumb-item"><a href="{{ url('/') }}/administracion/catalogo/motivoAlarmas">Motivo Alarma</a></li>  
...
<div style="margin: 25px auto; width:95%;">
    ...
    {{ Form::open(array('url'=>'/administracion/catalogo/motivoAlarmas','method' => 'post','id' => 'registro','role'=>'form' )) }}

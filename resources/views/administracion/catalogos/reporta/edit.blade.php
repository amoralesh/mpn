...
@section('directorioTitle', 'Editar Reporta') 
@section('directorio')
...
<div style="margin: 25px auto; width:95%;">
   ...
   <div class="box">
      ...
      <div class="box-body">
         ...
         @endif
         {{ Form::open(array('url'=>'/administracion/catalogo/reporta/'.$reporta->getId(),'method' => 'PUT','id' => 'registro','role'=>'form' )) }}
         <div class="row">
            <div class="col-sm-12 col-md-12">
               ...
               <div class="form-group">
                  ...
                  <input type="text" value="{{$reporta->getEtiqueta()}}" name="nombre" id="nombre" class="form-control" placeholder="Nombre">
         ...
         <div class="box-footer">
            En este apartado podemos modificar quien reporta
         </div>
         <!-- /.box-footer-->
      </div>
      <!-- /.box -->

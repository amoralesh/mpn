...
@section('directorioTitle', 'Nueva Reporta') 
@section('directorio')
    <li class="breadcrumb-item"><a href="{{ url('/') }}/administracion/catalogo/reporta">Reporta</a></li>
...
<div style="margin: 25px auto; width:95%;">
    ...
    {{ Form::open(array('url'=>'/administracion/catalogo/reporta','method' => 'post','id' => 'registro','role'=>'form' )) }}

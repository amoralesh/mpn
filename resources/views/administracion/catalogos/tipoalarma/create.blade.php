...
@section('directorioTitle', 'Nuevo Tipo Alarma') 
@section('directorio')
    <li class="breadcrumb-item"><a href="{{ url('/') }}/administracion/catalogo/tipoAlarmas">Tipo Alarmas</a></li> 
...
<div style="margin: 25px auto; width:95%;">
    ...
    {{ Form::open(array('url'=>'/administracion/catalogo/tipoAlarmas','method' => 'post','id' => 'registro','role'=>'form' )) }}

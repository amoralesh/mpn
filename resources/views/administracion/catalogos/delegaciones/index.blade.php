...
@section('titulo', 'Delegación')
@section('dependencia', ' - Policía Preventiva - ')


@section('directorioTitle', 'Delegación')
@section('directorio')
    <li class="breadcrumb-item ">Delegación</li>
@endsection
...
<div style="margin: 25px auto; width:95%;">
    ...
    <button type="button" id="crear" class="btn btn-primary">Crear nueva delegación</button>
    
    <section style="margin-top:20px;"> 
        <table class="table table-striped table-bordered table-hover" id="delegacionesDT">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Delegación</th>
...
<script>
    $(function() {
        ...
        $('#crear').on('click', function(e) {
            document.location.href = "{{ url('/') }}/administracion/catalogo/delegaciones/create";
            e.stopPropagation();
        });
    ...
    function listAllDelegaciones(){
        
        var table = $('#delegacionesDT').DataTable({
            ...
            "processing": true,
            "ajax": {
                "url": "{{ url('/') }}/administracion/rest/catalogo/delegaciones",
                "type": "GET",
                "dataSrc": "", 
        ...
        $('#delegacionesDT tbody').on('click', '#editar', function(e) {
            ...
            document.location.href = "{{ url('/') }}/administracion/catalogo/delegaciones/" + id + "/edit";
            e.stopPropagation();
        });
    }

...
@section('directorioTitle', 'Nueva Delegación')
@section('directorio')
    <li class="breadcrumb-item"><a href="{{ url('/') }}/administracion/catalogo/delegaciones">Delegación</a></li> 
...
<div style="margin: 25px auto; width:95%;">
    ...
    {{ Form::open(array('url'=>'/administracion/catalogo/delegaciones','method' => 'post','id' => 'registro','role'=>'form' )) }}

...
@section('directorioTitle', 'Plaza Editar') 
...
<div style="margin: 25px auto; width:95%;">
    ...
    {{ Form::open(array('url'=>'/administracion/plazas/puertas/' . $negocio->getId(),'method' => 'PUT','enctype' => 'multipart/form-data','id' => 'registro','role'=>'form' )) }}
                                 ...
                                 <div class="panel-body">
                                    <div class="dataTable_wrapper">
                                       <table class="table table-striped table-bordered table-hover" id="tablaMercado">
                                          ...
                                          <tbody>
                                                 @foreach( $negocio->getPuertaPlazas() as $indice => $puertas )
                                                 <tr>
                                                    <td>{{$indice+1}}</td>

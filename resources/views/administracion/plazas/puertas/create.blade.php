...
@section('directorioTitle', 'Plaza Nueva') 
...
<div style="margin: 25px auto; width:95%;">
    ...
    {{ Form::open(array('url'=>'/administracion/plazas/puertas','method' => 'POST','enctype' => 'multipart/form-data','id' => 'registro','role'=>'form' )) }}
   ...
   <br><br>
                ...
                <div class="form-group">
                        <div class="box-header">
                            <h3 class="box-title">Referencias de la Plaza
            ...
            <div class="col-sm-6 col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <option {{ (7 == $tipoNegocio->getid() ? "selected" : "") }} value="{{ $tipoNegocio->getid() }} "> {{$tipoNegocio->getEtiqueta()}} </option>
                        @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <option {{ ( 1 == $giroNegocioGeneral->getId() ? "selected" : "") }} value="{{ $giroNegocioGeneral->getId() }} "> {{$giroNegocioGeneral->getEtiqueta()}} </option>
                        @endforeach
                        </select>
   ...
   <div class="col-sm-6 col-md-6">
      ...
      <div class="form-group">
         ...
         @endif
                ...
                <div class="box box-default"  id="puertas" name="puertas">
                        <div class="box-header with-border">
                           <br>
                           <h3 class="box-title"><span>Puertas de la plaza</span></h3>
                           <!--<br><br><br>
                ...
                <div class="form-group">
                    <div class="box-header">
                        <h3 class="box-title">Comentarios
                            <small>Comentarios sobre la actualización de la plaza.</small>
                        </h3>
                    </div>
                    <!-- /.box-header -->
...
<script>
    $(document).on('ready', function() {
        ...
        /* AL SELECCIONAR EL GIRO NEGOCIO GENERAL MUESTRA LA PUERTAS DE LA PLAZA
        ======================================================================================================= */
...
<script>
    ...
    /* MUESTRA LAS PUERTAS SI EL NEGOCIO ES UNA PLAZA
    ================================================================================= */
    function mostrar(id) {
        if (id == 1 || id == 40) {
            $("#puertas").show();

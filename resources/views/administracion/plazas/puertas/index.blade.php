...
<div style="margin: 25px auto; width:95%;">
    ...
    <button type="button" id="crear" class="btn btn-primary">Crear nueva plaza negocio</button>
...
<script>
    $(function() {
        ...
        $('#crear').on('click', function(e) {
            document.location.href = "{{ url('/') }}/administracion/plazas/puertas/create";
            e.stopPropagation();
        });
    ...
    function listAllEstablecimientos(){
        ...
        var table = $('#negociosDT').DataTable({
            ...
            "processing": true,
            "ajax": {  
                "url": "{{ url('/') }}/administracion/rest/plazas/puertas",
                "type": "POST",  
                "data": {
                    _token: token
                },
        ...
        $('#negociosDT tbody').on('click', '#editar', function(e) {
            ...
            var data = table.row(current_row).data();
            document.location.href = "{{ url('/') }}/administracion/plazas/puertas/" + data.id + "/edit";
            e.stopPropagation();
        });
    ...
    function findEstablecimientoById( data ) {      
        ...
        {   
            $.ajax({         
                url: "{{ url('/') }}/administracion/rest/dispositivos/plazas/puertas/" + data.id,
                type: "GET",       
                dataType : 'json',   
                beforeSend: function( xhr ) {
                    swal({ title: 'Recuperando Información' });

...
@section('titulo', 'Mercado Nuevo')
@section('dependencia', ' - Policía Preventiva - ')
@section('directorioTitle', 'Mercado Nuevo') 
...
<div style="margin: 25px auto; width:95%;">
    ...
    {{ Form::open(array('url'=>'/administracion/mercados','method' => 'POST','enctype' => 'multipart/form-data','id' => 'registro','role'=>'form' )) }}
...
<br><br>
                ...
                <div class="form-group">
                        <div class="box-header">
                            <h3 class="box-title">Referencias del Mercado

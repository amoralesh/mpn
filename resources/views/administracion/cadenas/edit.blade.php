...
@section('titulo', 'Cadena Editar')
@section('dependencia', ' - Policía Preventiva - ')

@section('directorioTitle', 'Cadena Editar')
@section('directorio')
...
<div style="margin: 25px auto; width:95%;">
    ...
    {{ Form::open(array('url'=>'/administracion/cadenas/'.$cadena->getId(),'method' => 'put','id' => 'registro','role'=>'form' )) }}
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12">
               ...
               <div class="form-group">
                    ...
                    <input type="text" value="{{ $cadena->getEtiqueta() }} " name="nombre" id="nombre" class="form-control" placeholder="Nombre">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $cadena->getAlias() }}" name="alias" id="alias" class="form-control" placeholder="alias">
                    @if ($errors->has('alias'))
               ...
               <div class="form-group">
                    ...
                    <select name="asociacion" id="asociacion" class="form-control select2">
                        @foreach($asociacionList as $asociacion)
                            <option {{ ( $cadena->getAsociacion()->getId() == $asociacion->getId()  ? "selected" : "") }} value="{{ $asociacion->getid() }} "> {{ $asociacion->getEtiqueta() }} </option>
                        @endforeach 
                    </select>
        ...
        <section style="margin-top:20px;">
            ...
            <input type="text" value="{!! old('encargadosList') !!} {{ implode(",",$encargadosList)  }}" name="encargadosList" id="encargadosList" class="form-control" placeholder="Encargados">
        </section>

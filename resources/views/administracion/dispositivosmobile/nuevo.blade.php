...
@section('titulo', 'Dispositivos Movil | Nuevo')
@section('dependencia', ' - Policía Preventiva - ')


@section('directorioTitle', 'Dispositivos Movil | Nuevo')
@section('directorio')
	<li class="breadcrumb-item"><a href="{{ url('/') }}/dispositivos/mobile">Dispositivos Movil</a></li>
...
<div style="margin: 25px auto; width:95%;">
   ...
   <!-- FORMULARIO PRINCIPAL
      ================================== -->
   <!-- form start -->
   {{ Form::open(array('url'=>'/administracion/dispositivos/mobile', 'role'=>'form')) }}
   <div class="box-body">
        ...
        <input type="text" value="{!! old('idUnico') !!}" name="idUnico" id="idUnico" class="form-control" placeholder="ID - Único ó IMEI">
    ...
    <div class="form-group">
        ...
        <input type="text" value="{!! old('alias') !!}" name="alias" id="alias" class="form-control" placeholder="Alias ó PAC">
        @if ($errors->has('alias'))
        <div class="alert alert-danger">
    ...
    <div class="form-group">
        ...
        <input type="text" value="{!! old('numero') !!}" name="numero" id="numero" class="form-control" placeholder="Número ó  ">
    ...
    <div class="form-group">
        ...
        <input type="modelo" value="{!! old('modelo') !!}" name="modelo" id="modelo" class="form-control" placeholder="Modelo de teléfono o device type ">
    ...
    <div class="form-group">
        ...
        <input type="text" value="{!! old('version') !!}" name="version" id="version" class="form-control" placeholder="Versión Android ó protocol versión">
    ...
    <div class="form-group">
        ...
        <select name="tipo" id="tipo" class="form-control">
            ...
            <option {{ (old("tipo") == $tipo->getid() ? "selected" : "") }} value="{{$tipo->getid()}}">{{$tipo->getEtiqueta()}}</option>
            @endforeach
        </select>

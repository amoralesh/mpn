...
@section('titulo', 'Alertas | Lista')
@section('dependencia', ' - Policía Preventiva - ')


@section('directorioTitle', 'Alertas | Lista')
@section('directorio')
...
<div style="margin: 25px auto; width:95%;">
   ...
   <br>
    ...
    <h4>Mostrando las alertas del día de hoy</h4>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        Alertas( moment().startOf('day').format('YYYY-MM-DD HH:mm:ss') , moment().endOf('day').format('YYYY-MM-DD HH:mm:ss') );
        ...
        $('input[name="fechas"]').daterangepicker({
            ...
            "locale": { 
                ...
                Alertas( start.format('YYYY-MM-DD HH:mm:ss')  , end.format('YYYY-MM-DD HH:mm:ss')  ); 
            } 
        );
        ...
        function Alertas(fechaInicio, fechaFin) { 

            $('#alertasDT').dataTable().fnDestroy();
            var table = $('#alertasDT').DataTable({
                responsive: true,
                "autoWidth": false,
                "deferRender": true, 	
	            "pageLength": 50,
                ...
                "processing": true,
                "ajax": {
                    "url": "{{ url('/') }}/administracion/rest/alertas/rango",
                    "type": "POST",    
                    "data" : {

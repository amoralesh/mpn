...
@section('titulo', 'Escuela Editar')
@section('dependencia', ' - Policía Preventiva - ')
@section('directorioTitle', 'Escuela Editar') 
...
<div style="margin: 25px auto; width:95%;">
        ...
        @endif
        {{ Form::open(array('url'=>'/administracion/escuelas/' . $negocio->getId(),'method' => 'PUT','enctype' => 'multipart/form-data','id' => 'registro','role'=>'form' )) }}
        <div class="row">
           <!-- ================================== FILA 1 ================================== -->
        ...
        <div class="row">
           ...
           <div class="col-sm-6 col-md-6">
              ...
              <section style="margin-top:20px;  z-index:1;" id="dispo" name="dispo">
                 <br> <br>
                 <h3 class="box-title"><span>Dispositivos del mercado</span></h3>
                 <table class="table table-striped table-bordered table-hover" id="dispositivos" name="dispositivos" >
                    ...
                    <tbody>
                       ...
                       <tr>
                          @foreach($negocio->getDispositivos() as $dispositivo)
                          @if( $dispositivo->getTipoDispositivo()->getId() == $tpd->getId() )
                          <td style="display:none;" ><input type="hidden" name="idDispositivo[]" id="idDispositivo[]" value="{{ $dispositivo->getId() }}"></td>
                          <td style="display:none;" ><input type="hidden" name="idTipoDispositivo[]" id="idTipoDispositivo[]" value="{{ $tpd->getId() }}"></td>
                          <td><input style="width: 100%;" name="tipoDispositivo[]" id="tipoDispositivo[]" value="{{ $tpd->getEtiqueta() }}"></td>
                          <td><input type="text" name="cantidad[]" id="cantidad[]" value="{{ $dispositivo->getCantidad() == null ? '0': $dispositivo->getCantidad()  }}"></td>
                          @break
                          @else
                          <?php $a = false; ?>
                          @foreach( $negocio->getDispositivos() as $dispositivo)
                          ...
                          @endforeach
                          @if( $a == false )
                          <td style="display:none;" ><input type="hidden" name="idDispositivo[]" id="idDispositivo[]" value="0"></td>
                          <td style="display:none;" ><input type="hidden" name="idTipoDispositivo[]" id="idTipoDispositivo[]" value="{{ $tpd->getId() }}"></td>
                          <td><input  style="width: 100%;" name="tipoDispositivo[]" id="tipoDispositivo[]" value="{{ $tpd->getEtiqueta() }}"></td>
              ...
              <div class="form-group">
                 <div class="box-header">
                    <h3 class="box-title">Referencias de la Escuela
              ...
              <div class="form-group">
                 <div class="box-header">
                    <h3 class="box-title">Comentarios
                       <small>Comentarios sobre la actualización de la Escuela.</small>
                    </h3>
                 </div>
                 <!-- /.box-header -->

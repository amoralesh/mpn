...
@section('directorio')
    <li class="breadcrumb-item active">Dashboard Escuelas</li>
@endsection
        ...
        <div class="contain-inner dashboard-v2">
           ...
           <div class="row">
                 ...
                 <div class="widget-box" style="background-color:#E1E3E3;">
                    <div class="widget-info">
                       <div class="widget-content">
                          <h5 class="crm-title text-xs-center">Escuelas</h5>
              ...
              <div class="col-xs-3">
                 <div class="widget-box" style="background-color:#E1E3E3;">
                    <div class="widget-info">
                       <div class="widget-content">
                          <h5 class="crm-title text-xs-center">Tiempo Promedio</h5>
                          <div class="text-xs-center">
                             <input data-plugin="jknob" type="text" data-angleArc=360
                                data-bgColor="rgba(255,72,89,0.1)"
                                data-fgColor="#07A0BB"
           ...
           <div class="row">
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
                 ...
                 <div class="content">
                    <div class="dashboard-header">
                       <h2 class="page-content-title float-xs-left" ><b>Escuelas</b></h2>
                       <div class="dashboard-action">
                          <ul class="right-action float-xs-right">

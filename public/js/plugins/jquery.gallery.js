(function($) {
    $.fn.createSimpleImgGallery = function() {
        ...
        var lOverlay_jqe = $('<div id="codengineering_overlay"></div>'),
                lWrapper_jqe = $('<div class="wrapper2"></div>'),
                lImgInnerWrapper_jqp = $('<div class="img_inner_wrapper2" data-rotation="0"></div>'),
                lImgWrapper_jqp = $('<div class="img_wrapper2"></div>'),
                ...
                lSettingsWrapper_jqe = $('<div class="settings_wrapper2"></div>'),
                ...
                lLoadingWrapper_jqe = $('<div class="loading_wrapper2"></div>'),

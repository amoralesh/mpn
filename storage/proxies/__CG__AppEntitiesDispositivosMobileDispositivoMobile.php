...
namespace DoctrineProxies\__CG__\App\Entities\DispositivosMobile;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class DispositivoMobile extends \App\Entities\DispositivosMobile\DispositivoMobile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\DispositivosMobile\\DispositivoMobile' . "\0" . 'id', '' . "\0" . 'App\\Entities\\DispositivosMobile\\DispositivoMobile' . "\0" . 'idUnico', '' . "\0" . 'App\\Entities\\DispositivosMobile\\DispositivoMobile' . "\0" . 'alias', '' . "\0" . 'App\\Entities\\DispositivosMobile\\DispositivoMobile' . "\0" . 'numero', '' . "\0" . 'App\\Entities\\DispositivosMobile\\DispositivoMobile' . "\0" . 'modelo', '' . "\0" . 'App\\Entities\\DispositivosMobile\\DispositivoMobile' . "\0" . 'version', '' . "\0" . 'App\\Entities\\DispositivosMobile\\DispositivoMobile' . "\0" . 'tipoDispositivo', '' . "\0" . 'App\\Entities\\DispositivosMobile\\DispositivoMobile' . "\0" . 'token', 'usuariosPublicos', 'usuariosMobile', '' . "\0" . 'App\\Entities\\DispositivosMobile\\DispositivoMobile' . "\0" . 'permisos', '' . "\0" . 'App\\Entities\\DispositivosMobile\\DispositivoMobile' . "\0" . 'fechaAlta', '' . "\0" . 'App\\Entities\\DispositivosMobile\\DispositivoMobile' . "\0" . 'status', '' . "\0" . 'App\\Entities\\DispositivosMobile\\DispositivoMobile' . "\0" . 'motivosAltaBaja'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DispositivoMobile $proxy) {

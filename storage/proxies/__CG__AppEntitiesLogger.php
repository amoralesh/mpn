 ...
 */
class Logger extends \App\Entities\Logger implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Logger' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Logger' . "\0" . 'fecha', '' . "\0" . 'App\\Entities\\Logger' . "\0" . 'usuario', '' . "\0" . 'App\\Entities\\Logger' . "\0" . 'accion'];
        }

 ...
 */
class Permiso extends \App\Entities\Usuarios\Permiso implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Usuarios\\Permiso' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Usuarios\\Permiso' . "\0" . 'nombre', '' . "\0" . 'App\\Entities\\Usuarios\\Permiso' . "\0" . 'descripcion', '' . "\0" . 'App\\Entities\\Usuarios\\Permiso' . "\0" . 'fechaAlta'];
        }

 ...
 */
class PermisoPublico extends \App\Entities\UsuariosPublico\PermisoPublico implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\UsuariosPublico\\PermisoPublico' . "\0" . 'id', '' . "\0" . 'App\\Entities\\UsuariosPublico\\PermisoPublico' . "\0" . 'nombre', '' . "\0" . 'App\\Entities\\UsuariosPublico\\PermisoPublico' . "\0" . 'descripcion', '' . "\0" . 'App\\Entities\\UsuariosPublico\\PermisoPublico' . "\0" . 'fechaAlta'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PermisoPublico $proxy) {

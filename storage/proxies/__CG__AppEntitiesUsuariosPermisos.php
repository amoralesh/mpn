 ...
 */
class Permisos extends \App\Entities\Usuarios\Permisos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Usuarios\\Permisos' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Usuarios\\Permisos' . "\0" . 'nombre', '' . "\0" . 'App\\Entities\\Usuarios\\Permisos' . "\0" . 'descripcion', '' . "\0" . 'App\\Entities\\Usuarios\\Permisos' . "\0" . 'fechaAlta', '' . "\0" . 'App\\Entities\\Usuarios\\Permisos' . "\0" . 'status', '' . "\0" . 'App\\Entities\\Usuarios\\Permisos' . "\0" . 'motivoBaja', '' . "\0" . 'App\\Entities\\Usuarios\\Permisos' . "\0" . 'motivoAlta'];
        }

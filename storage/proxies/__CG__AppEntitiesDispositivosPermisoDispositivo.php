 ...
 */
class PermisoDispositivo extends \App\Entities\Dispositivos\PermisoDispositivo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Dispositivos\\PermisoDispositivo' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Dispositivos\\PermisoDispositivo' . "\0" . 'nombre', '' . "\0" . 'App\\Entities\\Dispositivos\\PermisoDispositivo' . "\0" . 'descripcion', '' . "\0" . 'App\\Entities\\Dispositivos\\PermisoDispositivo' . "\0" . 'fechaAlta', 'dispositivos'];
        }

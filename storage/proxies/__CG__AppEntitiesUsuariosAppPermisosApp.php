 ...
 */
class PermisosApp extends \App\Entities\UsuariosApp\PermisosApp implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\UsuariosApp\\PermisosApp' . "\0" . 'id', '' . "\0" . 'App\\Entities\\UsuariosApp\\PermisosApp' . "\0" . 'nombre', '' . "\0" . 'App\\Entities\\UsuariosApp\\PermisosApp' . "\0" . 'descripcion', '' . "\0" . 'App\\Entities\\UsuariosApp\\PermisosApp' . "\0" . 'fechaAlta', '' . "\0" . 'App\\Entities\\UsuariosApp\\PermisosApp' . "\0" . 'status'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PermisosApp $proxy) {

 ...
 */
class InstitucionPublico extends \App\Entities\UsuariosPublico\InstitucionPublico implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\UsuariosPublico\\InstitucionPublico' . "\0" . 'id', '' . "\0" . 'App\\Entities\\UsuariosPublico\\InstitucionPublico' . "\0" . 'nombre', '' . "\0" . 'App\\Entities\\UsuariosPublico\\InstitucionPublico' . "\0" . 'nombreCorto', '' . "\0" . 'App\\Entities\\UsuariosPublico\\InstitucionPublico' . "\0" . 'fechaAlta', '' . "\0" . 'App\\Entities\\UsuariosPublico\\InstitucionPublico' . "\0" . 'status'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InstitucionPublico $proxy) {

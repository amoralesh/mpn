...
namespace DoctrineProxies\__CG__\App\Entities\Usuarios;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Usuario extends \App\Entities\Usuarios\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Usuarios\\Usuario' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Usuarios\\Usuario' . "\0" . 'remember_token', '' . "\0" . 'App\\Entities\\Usuarios\\Usuario' . "\0" . 'usuario', '' . "\0" . 'App\\Entities\\Usuarios\\Usuario' . "\0" . 'password', '' . "\0" . 'App\\Entities\\Usuarios\\Usuario' . "\0" . 'email', '' . "\0" . 'App\\Entities\\Usuarios\\Usuario' . "\0" . 'nombre', '' . "\0" . 'App\\Entities\\Usuarios\\Usuario' . "\0" . 'apellidoPaterno', '' . "\0" . 'App\\Entities\\Usuarios\\Usuario' . "\0" . 'apellidoMaterno', '' . "\0" . 'App\\Entities\\Usuarios\\Usuario' . "\0" . 'placa', '' . "\0" . 'App\\Entities\\Usuarios\\Usuario' . "\0" . 'institucion', '' . "\0" . 'App\\Entities\\Usuarios\\Usuario' . "\0" . 'permisos', '' . "\0" . 'App\\Entities\\Usuarios\\Usuario' . "\0" . 'fechaAlta', '' . "\0" . 'App\\Entities\\Usuarios\\Usuario' . "\0" . 'status', '' . "\0" . 'App\\Entities\\Usuarios\\Usuario' . "\0" . 'motivosAltaBaja', 'createdAt', 'updatedAt'];
        }

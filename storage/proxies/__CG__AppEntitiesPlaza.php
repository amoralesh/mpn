 ...
 */
class Plaza extends \App\Entities\Plaza implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Plaza' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Plaza' . "\0" . 'etiqueta', '' . "\0" . 'App\\Entities\\Plaza' . "\0" . 'alias', '' . "\0" . 'App\\Entities\\Plaza' . "\0" . 'direccion', '' . "\0" . 'App\\Entities\\Plaza' . "\0" . 'telefono', '' . "\0" . 'App\\Entities\\Plaza' . "\0" . 'extension', '' . "\0" . 'App\\Entities\\Plaza' . "\0" . 'status', '' . "\0" . 'App\\Entities\\Plaza' . "\0" . 'fechaAlta', '' . "\0" . 'App\\Entities\\Plaza' . "\0" . 'negocios', '' . "\0" . 'App\\Entities\\Plaza' . "\0" . 'encargados', '' . "\0" . 'App\\Entities\\Plaza' . "\0" . 'motivosAltaBaja'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Plaza $proxy) {

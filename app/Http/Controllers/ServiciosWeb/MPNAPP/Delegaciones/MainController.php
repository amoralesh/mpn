...
namespace App\Http\Controllers\ServiciosWeb\MPNAPP\Delegaciones;
...
class MainController extends Controller
{
    ...
    ==========================================*/
    /** VALIDADO */
    public function listAllMPNAPPDelegacion( Request $request )  
    {

        $delegaciones = $this->delegacionDao->listAll();
     
        $arregloDelegacion = array();
        foreach( $delegaciones as $indice => $delegacion ){
            ...
            $arregloDelegacion[] = $arreglo;
        }
     
        return response( $arregloDelegacion , 200)->header('Content-Type', 'application/json');               
    }
